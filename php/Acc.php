...
<head>
    ...
    <title>Accessory Catagories</title>
...
<body>
    <div class="container" id="main">
        ...
        <h2 style="text-align: center; margin-top: 10px;">สินค้าหมวด Accessory</h2>
        <div class="row">
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/Acc/s1.jpg" class="card-img-top" alt="..." >
                    <div class="card-body">
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/Acc/s2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/Acc/s3.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/Acc/s4.jpg" class="card-img-top" alt="..." >
                    <div class="card-body">
                ...
                <div class="col-sm-3">
                    <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                        <img src="../picture/Acc/s5.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-3">
                    <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                        <img src="../picture/Acc/s6.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
