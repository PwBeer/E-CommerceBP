...
<body>
    <div class="container" id="main">
        ...
        <h2 style="text-align: center; margin-top: 10px;">สินค้าหมวดกางเกง</h2>
        <div class="row">
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;" >
                    ...
                    <div class="card-body">
                      <h5 class="card-title">กางเกง 1</h5>
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/pant/p2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">กางเกง 2</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/pant/p3.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">กางเกง 3</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/pant/p4.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">กางเกง 4</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;" >
                    <img src="../picture/pant/p5.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">กางเกง 5</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/pant/p6.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">กางเกง 6</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/pant/p7.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">กางเกง 7</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
