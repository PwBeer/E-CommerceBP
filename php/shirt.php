...
<body>
    <div class="container" id="main">
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;" >
                    <img src="../picture/shirt/s1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 1</h5>
            ...
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 2</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s3.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 3</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s4.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 4</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s5.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 5</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s6.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 6</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s7.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 7</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s8.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 8</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s9.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 9</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s10.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 10</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s11.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 11</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s12.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 12</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s13.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 13</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s14.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 14</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s15.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 15</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
            <div class="col-sm-3">
                <div class="card" style="width: 80%; margin: 10px 0px 10px 10%; text-align: center;">
                    <img src="../picture/shirt/s16.jpg" class="card-img-top" alt="..." style="left: 50%;">
                    <div class="card-body">
                      <h5 class="card-title">เสื้อ 16</h5>
                      <a href="#" class="btn btn-primary">สั่งซื้อสินค้า</a>
                    </div>
                  </div>
            </div>
